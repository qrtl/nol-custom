...
class accounting_report_2(osv.osv_memory):
    _name = "accounting.report_2"
...
#         return result
    ...
    def check_report(self, cr, uid, ids, context=None):
        if context is None:
            context = {}
#         res = super(accounting_report_2, self).check_report(cr, uid, ids, context=context)
        used_context = super(accounting_report_2, self).check_report(cr, uid, ids, context=context)['data']['form']['used_context']
        data = {}
        data['head'] = {}
#         data['form'] = self.read(cr, uid, ids, ['account_report_id', 'date_from_cmp',  'date_to_cmp',  'fiscalyear_id_cmp', 'journal_ids', 'period_from_cmp', 'period_to_cmp',  'filter_cmp',  'chart_account_id', 'target_move'], context=context)[0]
        data['form'] = self.read(cr, uid, ids, ['account_report_id', 'fiscalyear_id', 'journal_ids', 'filter_cmp', 'chart_account_id'], context=context)[0]
